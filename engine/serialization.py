...
def load(file):
    ...
    logger.info(
        ...
        extra={"action": "load", "file_path": str(file_path)},
    )
    ...
    try:
        ...
        logger.debug(
            ...
            extra={"action": "parse_save", "file_path": str(file_path)},
        )
        ...
        logger.info(
            ...
            extra={
                ...
                "stashed_entity_count": len(
                    data["objects"]["stashed_entities"]
                ),
            },
        )
...
def _load_from_data(data, loadable_classes):
    ...
    logger.debug(
        ...
        extra={"action": "load_component_data", "component_count": len(data)},
    )

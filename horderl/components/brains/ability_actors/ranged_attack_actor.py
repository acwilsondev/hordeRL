...
from horderl.components.animation_controllers.blinker_animation_controller import BlinkerAnimationController
...
class RangedAttackActor(Brain):
    ...
    def back_out(self, scene):
        ...
        blinker = scene.cm.get_one(BlinkerAnimationController, entity=self.target)
        blinker.stop(scene)
    ...
    def _next_enemy(self, scene):
        ...
        old_blinker = scene.cm.get_one(BlinkerAnimationController, entity=self.target)
